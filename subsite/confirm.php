...
$page = new gsPage;
	...
	$page->page_name = 'confirm';		// page name for menu and other purpose
	...
	$index++;
	$content_list[$index]['file_name']='subsite/inc_confirm_code.php';
	$content_list[$index]['var_name']='content';
	$index++;
	$content_list[$index]['file_name']='subsite/inc_confirm_form.php';
	$content_list[$index]['var_name']='content';
