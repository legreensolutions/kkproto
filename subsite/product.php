...
$page = new gsPage;
	...
	$page->page_name = 'product';		// page name for menu and other purpose
	...
	$page->class_list = array("class_user.php","class_useritem.php");

    $page->css_list = array("item.css");
	...
	$index++;
	$content_list[$index]['file_name']='subsite/inc_product.php';
	$content_list[$index]['var_name']='content';
