...
$page = new gsPage;
	...
	$page->page_name = 'about_charity';		// page name for menu and other purpose
	...
	$page->class_list = array("class_user.php","class_userdetail.php","class_useritem.php", "class_gspagination.php");
	...
	$index++;
	$content_list[$index]['file_name']='subsite/inc_about_charity_code.php';
	$content_list[$index]['var_name']='content';
	$index++;
	$content_list[$index]['file_name']='subsite/inc_about_charity_form.php';
	$content_list[$index]['var_name']='content';
