...
$page = new gsPage;
	...
	$page->title = "Kaffakarma.com :: Payment :: Paypal";	// page Title
	$page->page_name = 'paypal';		// page name for menu and other purpose
	...
	$page->class_list = array("class_user.php","class_paypal.php","class_order.php");
