<?php
  ...
  if ( !defined('CHECK_INCLUDED') ){
	...
	$chk_user = $myuser->get_list_array_all();
...
//for pagination
	...
	if(isset($_GET["lstuser"])){
        ...
        $data_bylimit = $myorder->get_list_array_bylimit($search_string, $user_id,$Mypagination->start_record,$Mypagination->max_records);
