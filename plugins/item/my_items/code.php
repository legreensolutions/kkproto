...
<?php
        ...
        $MyItem = new UserItem($myconnection);
        ...
        $data_bylimit = $MyItem->get_list_array_bylimit(-1, "", "","","",$_SESSION[SESSION_TITLE.'userid'],"","","", $Mypagination->start_record,$Mypagination->max_records);
