<!-- form update start-->
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><input <?php if(isset($_SESSION[SESSION_TITLE.'gDEBUG']) && $_SESSION[SESSION_TITLE.'gDEBUG'] == true){ ?> checked="true" <?php }?>  type ="checkbox" name="chkdebug" value="1" size="20" /></td>
    </tr> 
      ...
      <td><input <?php if(isset($_SESSION[SESSION_TITLE.'gENABLE_GALLERY']) && $_SESSION[SESSION_TITLE.'gENABLE_GALLERY'] == true){ ?> checked="true" <?php }?> type ="checkbox" name="chkvieweditor" value="1" size="20" /></td>
    </tr> 
