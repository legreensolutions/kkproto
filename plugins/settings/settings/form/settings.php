<!-- form update start-->
    ...
    <tbody>
     ...
     <tr>
      <td class="caption" ><?php echo $conf_show_debug_window ?></td>
     ...
     <tr>
      <td class="caption" ><?php echo $conf_language ?></td>
      <td><?php loadlanguage("lstlanguage", -1, "Select Language",$_SESSION[SESSION_TITLE.'gLANGUAGE'],false,'style="width:210px; height:22;"'); ?></td>
    </tr>

    <tr>
    
    <td align="center" colspan="2"><input name="update" value="<?php echo $conf_submit_update ?>" type="submit"> &nbsp;&nbsp;
