...
$page = new gsPage;
    ...
    //$page->class_list = array("class_keywords.php");

    $page->css_list = array("form.css");

	//$page->pageconf_list = array("keywords.php");
	...
	$index++;
	$content_list[$index]['file_name']='inc_keywords_code.php';
	$content_list[$index]['var_name']='content';
	$index++;
	$content_list[$index]['file_name']='inc_keywords_form.php';
	$content_list[$index]['var_name']='content';
