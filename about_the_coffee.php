...
$page = new gsPage;
	...
	$page->page_name = 'about_the_coffee';		// page name for menu and other purpose
	...
	$page->pageconf_list = array("about_the_coffee.php");

	$index=0;
	$content_list[$index]['file_name']='inc_left_menu.php';
	$content_list[$index]['var_name']='left_menu';
	$index++;
	$content_list[$index]['file_name']='inc_about_the_coffee.php';
