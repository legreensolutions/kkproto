...
$page = new gsPage;
    ...
    $page->class_list = array("class_user.php","class_item.php", "class_state.php", "class_country.php", "class_city.php", "class_customer.php", "class_order.php","class_orderitem.php","class_gspagination.php");
