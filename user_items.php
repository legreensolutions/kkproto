...
$page = new gsPage;
    ...
    $page->page_name = 'faq_search';     // page name for menu and other purpose
    ...
    $page->class_list = array("class_gspagination.php", "class_item.php", "class_useritem.php", "class_user.php");
