<?php 
        ...
        $data_bylimit = $myuseritem->get_list_array_bylimit(gINVALID, "","", ITEMSTATUS_IN_STOCK, ITEMTYPE_KAFFAKARMA, $_SESSION[SESSION_TITLE.'charity_id'], gINVALID, "", $Mypagination->start_record,$Mypagination->max_records);
