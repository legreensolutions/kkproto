...
--
-- Host: localhost
-- Generation Time: Jul 24, 2013 at 08:09 AM
...
INSERT INTO `orderitems` (`id`, `order_id`, `item_id`, `quantity`, `unit_price`, `amount`, `shipping_amount`, `tax`, `commission`, `commission_amount`) VALUES
(1, 1, 2, 10, 15, 150, 0, 0, 1, 10);
...
INSERT INTO `orders` (`id`, `order_number`, `order_date`, `user_id`, `customer_id`, `shipping`, `shipping_amount`, `tax`, `order_amount`, `commission_amount`, `order_status_id`, `paymentoption_id`, `paymentdate`, `paymentdetail`, `payment_status_id`) VALUES
(1, '1', '2013-07-23 00:00:00', 0, 1, 1, 0, 0, 150.00, 0, 1, 1, '0000-00-00 00:00:00', '', 1);
