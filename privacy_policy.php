...
$page = new gsPage;
	...
	$page->page_name = 'privacy_policy';		// page name for menu and other purpose
	...
	$page->class_list = array("class_user.php");
        ...
        $page->pageconf_list = array("privacy_policy.php");

	$index=0;
	$content_list[$index]['file_name']='inc_left_menu.php';
	$content_list[$index]['var_name']='left_menu';
	$index++;
	$content_list[$index]['file_name']='inc_privacy_policy.php';
